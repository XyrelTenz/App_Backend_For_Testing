...
class NotificationController(
    ...
    fun registerFcmToken(
        ...
        return ResponseEntity.ok(ApiResponse.success(mapOf("message" to "Token registered successfully")))
    }
    ...
    fun unregisterFcmToken(@RequestParam token: String): ResponseEntity<ApiResponse<*>> {
        ...
        return ResponseEntity.ok(ApiResponse.success(mapOf("message" to "Token unregistered successfully")))
    }
}
